...
const Client = require('@mysql/xdevapi/lib/Protocol/Client');
const WorkQueue = require('@mysql/xdevapi/lib/WorkQueue');
const SqlResultHandler = require('@mysql/xdevapi/lib/Protocol/ResponseHandler').SqlResultHandler;
...
describe('Client', () => {
    ...
    context('enableSSL()', () => {
        ...
        beforeEach('create fakes', () => {
            ...
            FakeClient = proxyquire('@mysql/xdevapi/lib/Protocol/Client', {
