var decode = require('@mysql/xdevapi/lib/Protocol/Datatype').decodeField;
var fieldtypes = require('@mysql/xdevapi/lib/Protocol/Messages/mysqlx_resultset').messages.ColumnMetaData.enums.FieldType;
